<div class="edit_profile">
  ...
  <div class="edit_main">
	...
	<div class="edit_steem_un_div">
	  <span class='edit_span'>Steemit Username</span>
	  <input type="text" name="edit_steem_un_text" value="<?php echo $universal->GETsDetails($session, "steemitusername"); ?>" class="edit_steem_un_text" placeholder="@username" spellcheck="false" autofocus>
	</div>
