  ...
  class forgot{
    ...
    public function retrieve($input){
      ...
      if ($scount == 0) {
        ...
        $mail->setFrom($this->gmail, 'Steemagram');
        $mail->addAddress($email);               // Name is optional
        $mail->addReplyTo($this->gmail, 'Steemagram');
        ...
        $mail->Subject = 'Activate your Steemagram account';

        $mail->Body = "<span>Hello, You received this message because you created an account on Steemagram.<span><br>
        <span>Click on button below to retrieve your Steemagram account and explore.</span><br><br>
