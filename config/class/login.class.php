  ...
  class login_class{
    ...
    public function REGISTER($username, $firstname, $surname, $email, $password, $pri_ip){
      ...
      if (($username || $firstname || $surname || $email || $password) == "") {
        ...
        $mail->Subject = 'Verify your Steemagram account';

        $mail->Body = "<span>Hello, You received this message because you created an account on Steemagram.<span><br>
        <span>Click on button below to verify your Steemagram account and explore.</span><br><br>
