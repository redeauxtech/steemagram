...
<?php
  $title = "{$noti->titleNoti()} *$tag • Steemagram";
  $keywords = "$tag, Steemagram, steemit, decentralize, pictures, videos, groups, blockchain, crypto, currency";
  $desc = "View people with $tag tag • Steemagram";
?>
