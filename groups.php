...
<?php
  $title = "{$noti->titleNoti()} {$groups->GETgrp($grp, 'grp_name')} • Steemagram";
  $keywords = "steemagram, blockchain, steem, steemit, videos, pictures, sharing, share, upvote, crypto, currency";
  $desc = "Steemagram is a blockchain based social network! Share pictures, videos and make new friends. Join and create groups.";
?>
...
<div class="badshah">
  ...
  <?php if($groups->memberOrNot($grp, $session) == false && $groups->GETgrp($grp, "grp_privacy") == "private"){ ?>
    ...
    <span>Hey this group is private, you will have to join it in order to view it. Join this group and refresh it to view the group's content.</span>
