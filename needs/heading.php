<body>
  <div class="header">
    <div class="logo">
      <a href="<?php echo DIR; ?>"><img src="<?php echo DIR; ?>/images/needs/icon40x40.png" alt="Steemagram"></a>
    </div>
    <div class="search_box">
      <?php if($universal->isLoggedIn()){ ?>
      <input type="text" name="" placeholder="Search Steemagram" spellcheck="false" autocomplete="off" class="search" autofocus>
